...
public class LoginLayout extends GridPane{
	...
	public LoginLayout(Stage create, HSQLDB db) {
		...
		registerButton.setOnAction(e -> {
			Scene cssStyle = new Scene(new Register(create,db),1000,600);
		...
		loginButton.setOnAction(e -> db.dbLoginQuery(usernameField, passwordField));
		setId("pane");
